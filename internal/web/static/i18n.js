...
const I18N = {
	de: {
		...
		libs_title: "Ziel-Bibliotheken", libs_hint: "Zielordner für Filme, Serien und Dokumentationen – Pfad per Ordnerauswahl.", lib_add: "＋ Bibliothek anlegen", lib_use_subfolders: "Unterordner pro Titel verwenden",
		...
		manual_target: "Ziel manuell wählen", manual_target_label: "Ziel manuell festlegen:",
		new_folder_label: "Neuer Ordner:", new_folder_ph: "Ordnername…", need_folder: "Bitte einen Ordnernamen angeben",
		remove_entry: "Eintrag entfernen", choose_lib: "— Bibliothek wählen —", choose_series: "— Serienordner —", choose_folder: "— Ordner wählen —",
	...
	en: {
		...
		libs_title: "Target libraries", libs_hint: "Target folders for movies, series and documentaries – pick the path via the folder browser.", lib_add: "＋ Add library", lib_use_subfolders: "Use per-title sub-folders",
		...
		manual_target: "Choose target manually", manual_target_label: "Set target manually:",
		new_folder_label: "New folder:", new_folder_ph: "Folder name…", need_folder: "Please enter a folder name",
		remove_entry: "Remove entry", choose_lib: "— choose library —", choose_series: "— series folder —", choose_folder: "— choose folder —",
