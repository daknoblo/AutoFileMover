...
const I18N = {
	de: {
		...
		clear_history: "Verlauf bereinigen",
		clear_queue: "Warteschlange bereinigen",
		clear_queue_confirm: "Erledigte, fehlgeschlagene und verwaiste Jobs entfernen? Gültige wartende und laufende Jobs bleiben erhalten. Dateien werden nicht gelöscht.",
		queue_cleared: "{n} Jobs entfernt. Quellen werden im Hintergrund geprüft.",
		clear_history_confirm: "Verlauf und zugehörige abgeschlossene/fehlgeschlagene Jobs entfernen? Dateien werden nicht gelöscht. Noch vorhandene Quellen können beim nächsten Scan erneut erscheinen.",
		history_cleared: "{n} Verlaufseinträge entfernt",
		refresh_failed: "Dateisystem-Abgleich fehlgeschlagen. Die angezeigten Listen sind möglicherweise veraltet:",
		refresh_running: "Dateisystem-Abgleich läuft im Hintergrund. Die Listen zeigen den zuletzt gespeicherten Stand und werden nach Abschluss aktualisiert.",
		...
		ai_api_version: "Azure API-Version", ai_api_version_hint: "(nur für .openai.azure.com-Deployments; leer lassen für OpenAI und Foundry-/openai/v1-Endpunkte)", ai_api_key: "API-Key",
		ai_deployment: "Foundry-Deployment",
		ai_deployment_hint: "Aus Azure ermittelt; Zugangsdaten kommen aus den Umgebungsvariablen.",
		ai_deployment_none: "– kein Deployment gewählt –",
		ai_deployment_missing: "in Azure nicht mehr verfügbar",
		ai_deployment_count: "{n} Chat-Deployments",
		ai_deployments_loading: "Deployments werden geladen …",
		ai_reasoning: "Reasoning",
		ai_reload_deployments: "Deployments neu laden",
		ai_test: "Verbindung testen",
		ai_test_running: "Verbindung wird getestet …",
		ai_test_ok: "Verbindung erfolgreich ({ms} ms)",
		ai_test_failed: "Verbindung fehlgeschlagen:",
		...
		save: "Speichern", desc_ph: "Beschreibung als KI-Kontext…", lib_name_ph: "z. B. Filme",
		...
		was_deleted: "gelöscht", will_delete: "wird gelöscht", needs_review: "wartet auf Entscheidung",
		...
		conn_lost: "Verbindung gestört", req_timeout: "Zeitüberschreitung – Aktion läuft ggf. im Hintergrund weiter",
		queue_title: "Warteschlange",
		queue_hint: "Alle Datei-Aktionen laufen im Hintergrund. Ist der Speicher ausgelastet, bleiben sie hier stehen und werden automatisch wiederholt.",
		q_empty: "Keine Aufträge in der Warteschlange.",
		q_enqueued: "In Warteschlange aufgenommen", q_already_queued: "Steht bereits in der Warteschlange",
		q_queued: "in Warteschlange", q_running: "läuft", q_failed: "fehlgeschlagen",
		q_retry_in: "Wiederholung in {s}", q_attempts: "{n} Versuche",
		q_open: "{n} offen", q_failed_n: "{n} fehlgeschlagen", q_paused: "pausiert",
		q_paused_hint: "Warteschlange pausiert: Speicher nicht beschreibbar. Aufträge bleiben erhalten und laufen automatisch weiter.",
		q_retry: "Wiederholen", q_cancel: "Abbrechen",
	...
	en: {
		...
		clear_queue: "Clean up queue",
		clear_queue_confirm: "Remove completed, failed and orphaned jobs? Valid pending jobs and all running jobs are kept. No files will be deleted.",
		queue_cleared: "Removed {n} jobs. Sources are being checked in the background.",
		clear_history_confirm: "Remove history and its completed/failed jobs? No files will be deleted. Sources still on disk may reappear on the next scan.",
		history_cleared: "Removed {n} history entries",
		refresh_failed: "Filesystem refresh failed. The displayed lists may be out of date:",
		refresh_running: "Filesystem refresh is running in the background. Lists show the last saved state and will update when it finishes.",
		...
		ai_api_version: "Azure API version", ai_api_version_hint: "(only for .openai.azure.com deployments; leave empty for OpenAI and Foundry /openai/v1 endpoints)", ai_api_key: "API key",
		ai_deployment: "Foundry deployment",
		ai_deployment_hint: "Discovered from Azure; the credentials come from the environment variables.",
		ai_deployment_none: "– no deployment selected –",
		ai_deployment_missing: "no longer available in Azure",
		ai_deployment_count: "{n} chat deployments",
		ai_deployments_loading: "Loading deployments …",
		ai_reasoning: "reasoning",
		ai_reload_deployments: "Reload deployments",
		ai_test: "Test connection",
		ai_test_running: "Testing the connection …",
		ai_test_ok: "Connection succeeded ({ms} ms)",
		...
		save: "Save", desc_ph: "Description used as AI context…", lib_name_ph: "e.g. Movies",
		...
		was_deleted: "deleted", will_delete: "will be deleted", needs_review: "awaiting a decision",
		...
		conn_lost: "Connection lost", req_timeout: "Timed out – the action may still be running in the background",
		queue_title: "Queue",
		queue_hint: "All file actions run in the background. While the storage is busy they wait here and are retried automatically.",
		q_empty: "No queued jobs.",
		q_enqueued: "Added to the queue", q_already_queued: "Already queued",
		q_queued: "queued", q_running: "running", q_failed: "failed",
		q_retry_in: "retry in {s}", q_attempts: "{n} attempts",
		q_open: "{n} open", q_failed_n: "{n} failed", q_paused: "paused",
		q_paused_hint: "Queue paused: storage is not writable. Jobs are kept and resume automatically.",
		q_retry: "Retry", q_cancel: "Cancel",
